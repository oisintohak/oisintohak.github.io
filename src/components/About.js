                ...
                <div className="row align-items-center">
                    <div className="col">
                        ...
                        >
                            ...
                            >
                                <motion.h2 initial="initial" animate="animate" variants={headings} className="text-white py-3">Oisín Tohak</motion.h2>
                                <motion.h3 initial="initial" animate="animate" variants={headings2} className="text-white py-3">Fullstack Web Developer</motion.h3>
                                <motion.div
                                    variants={headings3}
                                ...
                                <motion.div variants={headings4} className="mx-auto lg:w-1/2 md:w-2/3">
